...
const char descriptor_table_protodef_public_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014public.proto\022\006fixbug\"-\n\nResultCode\022\017\n\007"
  "errcode\030\001 \001(\005\022\016\n\006errmsg\030\002 \001(\014b\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_public_2eproto = {
  false, false, 77, descriptor_table_protodef_public_2eproto, "public.proto", 
  &descriptor_table_public_2eproto_once, nullptr, 0, 1,
  schemas, file_default_instances, TableStruct_public_2eproto::offsets,
  file_level_metadata_public_2eproto, file_level_enum_descriptors_public_2eproto, file_level_service_descriptors_public_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK ::PROTOBUF_NAMESPACE_ID::Metadata
descriptor_table_public_2eproto_metadata_getter(int index) {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_public_2eproto);
  return descriptor_table_public_2eproto.file_level_metadata[index];
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY static ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptorsRunner dynamic_init_dummy_public_2eproto(&descriptor_table_public_2eproto);
namespace fixbug {
